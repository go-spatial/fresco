	...
	render (){
		...
		if (!this.state.open){
			return <div className="layer-group-heading mt-1">
				<button onClick={this.handle.open} type="submit" className="btn btn-gray btn-sm mr-2 btn-block text-left font-med">
					{type}
				</button>
			</div>
		}
		...
		return <div>
			<div className="layer-group-heading open mt-1">
				<button onClick={this.handle.close} type="submit" className="btn btn-gray btn-sm mr-2 btn-block text-left font-med">
					{type}
				</button>
			</div>
			<div className="p-2">
